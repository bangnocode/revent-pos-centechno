                        ...
                        <select name="nama_supplier"
                            ...
                            @foreach ($suppliers as $supplier)
                                <option value="{{ $supplier->nama_supplier }}"
                                    {{ old('nama_supplier', $barang->nama_supplier) == $supplier->nama_supplier ? 'selected' : '' }}>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                            <input type="text" name="harga_jual_normal"
                                value="{{ old('harga_jual_normal', (int) $barang->harga_jual_normal) }}"
                    ...
                    <!-- Stok -->
                    <div class="space-y-1">
                        <label class="block text-sm font-medium text-gray-700">Stok Sekarang <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="stok_sekarang"
                            value="{{ old('stok_sekarang', (int) $barang->stok_sekarang) }}"
