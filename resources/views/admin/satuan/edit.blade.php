...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Edit Satuan</h2>
    </div>

    <form action="{{ route('admin.satuan.update', $satuan) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="singkatan" value="{{ old('singkatan', $satuan->singkatan) }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" id="status_aktif" name="status_aktif" value="1" {{ old('status_aktif', $satuan->status_aktif) ? 'checked' : '' }}
