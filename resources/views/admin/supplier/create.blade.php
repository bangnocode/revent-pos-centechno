...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">Input data pemasok baru</p>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="kontak_person" value="{{ old('kontak_person') }}"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-100 outline-none transition-all">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3"
                        class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-100 outline-none transition-all">{{ old('alamat') }}</textarea>
                </div>

                <div class="flex items-center gap-2">
                    <input type="hidden" name="status_aktif" value="0">
                    <input type="checkbox" name="status_aktif" value="1" id="status_aktif" {{ old('status_aktif', '1') == '1' ? 'checked' : '' }}
